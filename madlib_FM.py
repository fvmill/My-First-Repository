...
print("Give me a plural part of a body")
pob1 = input()
...
print("'" + person + ", it's time to" + verb1 + "!'" "my mother called.")
print("I couldn't wait to get my" + pob1 + "on that" + adj2 + "Thanksgiving meal.")
